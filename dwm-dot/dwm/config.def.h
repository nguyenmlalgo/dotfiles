...
static const Key keys[] = {
    ...
    {0, XF86XK_AudioMute, spawn,
     SHCMD("~/dwm-dot/scripts/volume_control.sh mute")},
    {0, XF86XK_AudioLowerVolume, spawn,
     SHCMD("~/dwm-dot/scripts/volume_control.sh down")},
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("~/dwm-dot/scripts/volume_control.sh up")},
    {0, XF86XK_MonBrightnessUp, spawn,
     SHCMD("~/dwm-dot/scripts/brightness_control.sh up")},
    {0, XF86XK_MonBrightnessDown, spawn,
     SHCMD("~/dwm-dot/scripts/brightness_control.sh down")},
